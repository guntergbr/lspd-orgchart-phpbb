...
class install_sample_schema extends \phpbb\db\migration\migration
{
	...
	{
		return $this->db_tools->sql_column_exists($this->table_prefix . 'users', 'user_orgchart');
	}
	...
	public function update_schema()
	{
		return [
			'add_tables'		=> [
				$this->table_prefix . 'gunter_orgchart_table'	=> [
					'COLUMNS'		=> [
						'orgchart_id'			=> ['UINT', null, 'auto_increment'],
						'orgchart_name'			=> ['VCHAR:255', ''],
					],
					'PRIMARY_KEY'	=> 'orgchart_id',
				],
			],
			'add_columns'	=> [
				$this->table_prefix . 'users'			=> [
					'user_orgchart'				=> ['UINT', 0],
				],
			],
		];
	}
